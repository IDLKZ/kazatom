        ...
        <div class="row">
            ...
            <div class="col-md-12">
                @if ($errors->any())
                    ...
                    @endforeach
                @endif
                <form action="{{route('students.update', $student->id)}}" class="row g-4" enctype="multipart/form-data" method="post">
                @csrf
                @method('put')
                <!-- Profile picture -->
                        ...
                        <div class="d-flex align-items-center">
                            <label class="position-relative me-4" for="uploadfile-1" title="Replace this pic">
                                ...
                                <span class="avatar avatar-xl">
											<img id="uploadfile-1-preview" class="avatar-img rounded-circle border border-white border-3 shadow" src="{{$student->getFile('image')}}" alt="">
										</span>
                                <!-- Remove btn -->
                    ...
                    <div class="col-md-12">
                        ...
                        <input name="email" class="form-control" type="email" value="{{$student->email}}" placeholder="Email">
