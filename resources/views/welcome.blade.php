                                ...
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="index.html#" class="badge bg-purple bg-opacity-10 text-purple">All level</a>
                                            <a href="index.html#" class="h6 mb-0"><i class="far fa-heart"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Sketch from A to Z: for app designer</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="index.html#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                                            <a href="index.html#" class="text-danger"><i class="fas fa-heart"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Graphic Design Masterclass</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="index.html#" class="badge bg-success bg-opacity-10 text-success">Beginner</a>
                                            <a href="index.html#" class="h6 fw-light mb-0"><i class="far fa-heart"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Create a Design System in Figma</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Deep Learning with React-Native </a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Build Responsive Websites with HTML</a></h5>
                                        <p class="mb-2 text-truncate-2">Far advanced settling say finished raillery. Offered chiefly farther</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Build Websites with CSS</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Learn Invision</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">JavaScript: Full Understanding</a></h5>
                                        <p class="text-truncate-2 mb-2">Far advanced settling say finished raillery. Offered chiefly farther.</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">The Complete Web Development in python</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <a href="index.html#" class="badge bg-info bg-opacity-10 text-info">Intermediate</a>
                                            <a href="index.html#" class="h6 fw-light mb-0"><i class="far fa-heart"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Angular – The Complete Guider</a></h5>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Bootstrap 5 From Scratch</a></h5>
                                        <p class="text-truncate-2 mb-2">Far advanced settling say finished raillery. Offered chiefly farther</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">PHP with - CMS Project</a></h5>
                                        <p class="text-truncate-2 mb-2">Far advanced settling say finished raillery. Offered chiefly farther</p>
                                        <!-- Rating star -->
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item me-0 small"><i class="fas fa-star text-warning"></i></li>
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title fw-normal"><a href="index.html#">Digital Marketing Masterclass</a></h5>
                                ...
                                <div class="col-11 mx-auto position-relative">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-5 text-lg-end">
                                            <a href="index.html#" class="btn btn-outline-warning mb-0">Start Teaching Today</a>
                                        </div>
                                    </div>
                                </div>
                            </div> <!-- Row END -->
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
									...
									<span class="hstack gap-2">
										<a href="index.html#" class="badge bg-primary bg-opacity-10 text-primary">Design</a>
										<a href="index.html#" class="badge bg-dark text-white">Beginner</a>
									</span>
                                            <a href="index.html#" class="h6 fw-light mb-0"><i class="far fa-bookmark"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="index.html#">The complete Digital Marketing Course - 8 Course in 1</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="index.html#" class="h6 fw-light mb-0">Larry Lawson</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                                                <h4 class="text-success mb-0 item-show">Free</h4>
                                                <a href="index.html#" class="btn-sm btn-success-soft item-show-hover"><i class="fas fa-shopping-cart me-2"></i>Add to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    ...
                                    <div class="card-body pb-0">
                                        ...
                                        <div class="d-flex justify-content-between mb-3">
									<span class="hstack gap-2">
										<a href="index.html#" class="badge bg-primary bg-opacity-10 text-primary">Development</a>
										<a href="index.html#" class="badge bg-dark text-white">All level</a>
									</span>
                                            <a href="index.html#" class="h6 fw-light mb-0"><i class="far fa-bookmark"></i></a>
                                        </div>
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="index.html#">Angular – The Complete Guide (2021 Edition)</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="index.html#" class="h6 fw-light mb-0">Billy Vasquez</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
									...
									<span class="hstack gap-2">
                                        ...
                                        <!-- Title -->
                                        <h5 class="card-title"><a href="index.html#">Time Management Mastery: Do More,	Stress Less</a></h5>
                                        <!-- Rating -->
                                        <div class="d-flex justify-content-between mb-2">
                                            <div class="hstack gap-2">
                                                <p class="text-warning m-0">4.5<i class="fas fa-star text-warning ms-1"></i></p>
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="index.html#" class="h6 fw-light mb-0">Lori Stevens</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
                                    ...
                                    <div class="card-footer pt-0 bg-transparent">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <p class="mb-0 ms-2"><a href="index.html#" class="h6 fw-light mb-0">Frances Guerrero</a></p>
                                            </div>
                                            <!-- Price -->
                                            <div>
