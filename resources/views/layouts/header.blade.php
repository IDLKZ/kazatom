            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle active" href="index.html#" id="demoMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Demos</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pagesMenu">
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="index.html#">Course</a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                            ...
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="index.html#">About</a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                            ...
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="index.html#">Authentication</a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                    ...
                    <!-- Nav item 3 Account -->
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="index.html#" id="accounntMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Accounts</a>
                        <ul class="dropdown-menu" aria-labelledby="accounntMenu">
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="index.html#"><i class="fas fa-user-tie fa-fw me-1"></i>Instructor</a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                            ...
                            <!-- Dropdown submenu -->
                            <li class="dropdown-submenu dropend">
                                <a class="dropdown-item dropdown-toggle" href="index.html#"><i class="fas fa-user-graduate fa-fw me-1"></i>Student</a>
                                <ul class="dropdown-menu dropdown-menu-start" data-bs-popper="none">
                    ...
                    <li class="nav-item dropdown dropdown-fullwidth">
                        <a class="nav-link dropdown-toggle" href="index.html#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Megamenu</a>
                            ...
                            <div class="row p-4 g-4">
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <ul class="list-unstyled">
                                        <li> <a class="dropdown-item" href="index.html#">Market research</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Advertising</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Consumer behavior</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Digital marketing</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Marketing ethics</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Social media marketing</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Public relations</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Advertising</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Decision science</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">SEO</a> </li>
                                        <li> <a class="dropdown-item" href="index.html#">Business marketing</a> </li>
                                    </ul>
                                </div>
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <div class="mb-2 position-relative bg-primary-soft-hover rounded-2 transition-base p-3">
                                        <a class="stretched-link h6 mb-0" href="index.html#">Contact management</a>
                                        <p class="mb-0 small text-truncate-2">Speedily say has suitable disposal add boy. On forth doubt miles of child.</p>
                                    </div>
                                    <!-- Dropdown item -->
                                    <div class="mb-2 position-relative bg-primary-soft-hover rounded-2 transition-base p-3">
                                        <a class="stretched-link h6 mb-0" href="index.html#">Sales pipeline</a>
                                        <p class="mb-0 small text-truncate-2">Speedily say has suitable disposal add boy. On forth doubt miles of child.</p>
                                    </div>
                                    <!-- Dropdown item -->
                                    <div class="mb-2 position-relative bg-primary-soft-hover rounded-2 transition-base p-3">
                                        <a class="stretched-link h6 mb-0" href="index.html#">Security & Permission</a>
                                        <p class="mb-0 small text-truncate-2">Speedily say has suitable disposal add boy. On forth doubt miles of child.</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <div class="d-flex mb-4 position-relative">
                                        ...
                                        <div class="ms-2">
                                            <a class="stretched-link h6 mb-0" href="index.html#">Google SEO certificate</a>
                                    ...
                                    <div class="d-flex mb-4 position-relative">
                                        ...
                                        <div class="ms-2">
                                            <a class="stretched-link h6 mb-0" href="index.html#">Business Development Executive(BDE)</a>
                                            <p class="mb-0 small">No prerequisites</p>
                                        </div>
                                    </div>
                                    <!-- Dropdown item -->
                                    <div class="d-flex mb-4 position-relative">
                                        ...
                                        <div class="ms-2">
                                            <a class="stretched-link h6 mb-0" href="index.html#">Facebook social media marketing</a>
                                    ...
                                    <div class="d-flex mb-4 position-relative">
                                        ...
                                        <div class="ms-2">
                                            <a class="stretched-link h6 mb-0" href="index.html#">Creative graphics design</a>
                                            <p class="mb-0 small">No prerequisites</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-xxl-3">
                                    ...
                                    <div class="row g-2 justify-content-center mt-3">
                                        ...
                                        <div class="col-6 col-sm-4 col-xxl-6">
                                            <a href="index.html#"> <img src="/assets/images/client/google-play.svg" class="btn-transition" alt="google-store"> </a>
                                        </div>
                                        <!-- App store button -->
                                        <div class="col-6 col-sm-4 col-xxl-6">
                                            <a href="index.html#"> <img src="/assets/images/client/app-store.svg" class="btn-transition" alt="app-store"> </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-success alert-dismissible fade show mt-2 mb-0 rounded-3" role="alert">
                                        ...
                                        <!-- Info -->
                                        The personality development class starts at 2:00 pm, click to <a href="index.html#" class="alert-link">Join Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <!-- Nav item 5 link-->
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="index.html#" id="advanceMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
