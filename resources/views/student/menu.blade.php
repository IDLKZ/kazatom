            ...
            <div class="offcanvas-body p-3 p-xl-0">
                <div class="bg-dark border rounded-3 pb-0 p-3 w-100">
                    ...
                    <div class="list-group list-group-dark list-group-borderless">
                        ...
                        <a class="list-group-item {{Request::is('student') ? 'active' : ''}}" href="{{route('studentHome')}}"><i class="bi bi-basket fa-fw me-2"></i>Мои курсы</a>
                        ...
                        <a class="list-group-item {{Request::is('student/edit-profile') ? 'active' : ''}}" href="{{route('studentEditProfile')}}"><i class="bi bi-gear fa-fw me-2"></i>Настройки</a>
